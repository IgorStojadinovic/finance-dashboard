...
import RecurringBills from "../src/pages/Recurring";
...
describe("RecurringBills Component", () => {
    ...
    it("renders total bills section with correct information", () => {
        ...
        const totalBillsSection = screen.getByRole('contentinfo', { name: /total bills/i });
    ...
    it("renders summary section with correct details", () => {
        ...
        expect(within(summarySection).getByText("Total Upcoming")).toBeInTheDocument();
        expect(within(summarySection).getByText("6($1,220.00)")).toBeInTheDocument();
    ...
    it("renders bills list with correct items", () => {
        ...
        const billsListSection = screen.getByRole('region', { name: /bills list/i });
