...
describe("Home Page", () => {
    it("renders overview section with correct balances", () => {
        ...
        expect(screen.getByTestId("current-balance-amount")).toHaveTextContent("$4,860.00");
        expect(screen.getByTestId("income-amount")).toHaveTextContent("$3,814.25");
        expect(screen.getByTestId("expenses-amount")).toHaveTextContent("$1,700.50");
    });
    ...
    it("renders recurring bills section with correct information", () => {
        ...
        const seeDetailsLink = within(recurringBillsSection).getByText("see details");
        ...
        expect(screen.getByTestId("upcoming-bills-amount")).toHaveTextContent("$194.89");
    ...
    it("renders pots section with savings information", () => {
        ...
        expect(screen.getByTestId("concert-ticket-amount")).toHaveTextContent("$110");
    ...
    it("renders transactions section with links", () => {
        ...
        expect(transactionsList).toHaveAttribute('aria-label', 'Recent transactions');
    });
