            ...
            <div className="flex flex-col justify-between flex-1 gap-6 ">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <Link
                        ...
                        className={clsx(
                            {
                                " group flex items-center  w-[85%]  h-10 rounded-r-lg gap-4 py-2 px-10  hover:bg-white border-l-4  border-l-grey-900 hover:border-l-green  text-preset-3 text-grey-300 hover:text-grey-900 transition-all":
                                    !toggle,
                            },
                            {
                                "-translate-x-80 group flex items-center  w-[85%]  h-10 rounded-r-lg gap-4 py-2 px-10 hover:bg-white border-l-4  border-l-grey-900 hover:border-l-green  text-preset-3 text-grey-300 hover:text-grey-900 transition-all":
                                toggle,
                            }
                        )}
                    >
                    ...
                    <a href="https://github.com/IgorStojadinovic/finance-dashboard" target="_blank" className={clsx(
                        {
