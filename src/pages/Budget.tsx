...
const Budget = () => {
    ...
    return (
        <div className="xl:flex-1 bg-beige-100 py-6 px-4">
            ...
            <section className="flex flex-col mt-8 gap-6">
                <section className="bg-white rounded-lg ">
                    <div className="flex px-5 py-6 flex-col justify-center items-center md:flex-row xl:h-[200px]">
                ...
                {userBudget.map((item) => {
                    return (
                        <section className="bg-white rounded-lg" key={item.category}>
